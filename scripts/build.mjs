...
await cp(resolve(root, "src", "runtime-read-model.js"), resolve(dist, "runtime-read-model.js"));
await cp(resolve(root, "src", "runtime-read-model.d.ts"), resolve(dist, "runtime-read-model.d.ts"));
await cp(resolve(root, "src", "runtime-shell-state.js"), resolve(dist, "runtime-shell-state.js"));
await cp(resolve(root, "src", "runtime-shell-state.d.ts"), resolve(dist, "runtime-shell-state.d.ts"));
